...
TURN = {
    "zh": {
        ...
        "compare": "已按你提供的竞品规格对照 STM32。规格仍须核对厂家 datasheet。",
        ...
        "empty_compare": "指定系列里没有筛出短名单卡片，不能据此编造 STM32 订货号。竞品规格可能远高于该系列的主频或 Flash。请在该系列内按接近程度再查，或放宽系列后对照。",
        "need_specs": "只有竞品订货号还不能对照——本工具不凭料号推测规格。请上传该竞品的 datasheet（PDF 或清晰截图），或直接写出主频、Flash、RAM、封装等已核实的参数。",
    },
    "en": {
        ...
        "compare": "STM32 parts are ranked against the competitor specs you supplied. Confirm those specs on the vendor datasheet.",
        ...
        "empty_compare": "No shortlist cards in the named series, so this tool will not invent STM32 part numbers. The competitor clock or Flash may sit well above that series. Search for closeness inside the series, or widen the series and compare again.",
        "need_specs": "An orderable part number alone is not enough to compare — this tool does not infer specs from a part number. Upload that competitor datasheet (PDF or a clear screenshot), or type the verified clock, Flash, RAM, and package.",
    },
}
